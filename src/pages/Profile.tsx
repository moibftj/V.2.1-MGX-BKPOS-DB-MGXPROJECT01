...
const Profile = () => {
  ...
  const [users] = useState([
    { id: '1', name: 'Fadlan Nafian', email: 'fadlannafian@gmail.com', role: 'admin' },
    { id: '2', name: 'Rider 1', email: 'rider1@bkpos.com', role: 'rider' },
    { id: '3', name: 'Rider 2', email: 'rider2@bkpos.com', role: 'rider' },
  ]);
  ...
  const handleTaxUpdate = async () => {
    try {
      // In real app, this would call API to update tax settings
  ...
  const handleUserEdit = (userToEdit: any) => {
  ...
  const handleUserSubmit = (e: React.FormEvent) => {
    ...
    if (editingUser) {
      // Update existing user - would use API in real app
      toast.success('Pengguna berhasil diperbarui');
    } else {
      // Add new user - would use API in real app
  ...
  const handleUserDelete = (userId: string) => {
    ...
    // Delete user - would use API in real app
